 ...
 *
 * This module is the esbuild entrypoint (scripts/build-vercel.mjs), not
 * something Node loads directly: the workspace packages export raw TypeScript,
 * so the whole graph is bundled into one JS file before it ever reaches the
 * Vercel runtime.
 *
 * The Fastify instance is cached at module scope so warm invocations skip the
