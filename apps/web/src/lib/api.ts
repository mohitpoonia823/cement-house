...
// NOTE: request caching and deduplication are TanStack Query's job (staleTime,
// query keys, invalidateQueries). A second hand-rolled cache at the axios layer
// used to live here — it created a parallel invalidation system that mutations
// couldn't see. Keep this client a plain transport.
