  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#f7fafc_0%,#eef5f7_52%,#edf3f8_100%)] px-4 py-10 dark:bg-[linear-gradient(180deg,#020617_0%,#0f172a_56%,#111827_100%)]">
      ...
      <div className="relative mx-auto w-full max-w-4xl rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.10)] backdrop-blur sm:p-10 dark:border-slate-700 dark:bg-slate-900/80 dark:shadow-[0_20px_60px_rgba(2,6,23,0.45)]">
        <h1 className="text-3xl font-semibold text-slate-950 dark:text-slate-100 sm:text-4xl">NexaHub Blog</h1>
        <p className="mt-3 text-slate-600 dark:text-slate-300">Product updates, practical playbooks, and growth lessons for operations-first businesses.</p>

        <div className="mt-6 space-y-4">
          {[
            {
              title: 'Product updates',
              text: 'New features, bug fixes, and improvements to performance, reporting, and workflows.',
            },
            {
              title: 'Operations playbooks',
              text: 'Actionable guidance for inventory control, collections, dispatch planning, and team process hygiene.',
            },
            {
              title: 'Customer stories',
              text: 'How real teams use NexaHub to reduce manual work and improve visibility across daily operations.',
            },
          ].map((item) => (
        ...
        <p className="mt-6 text-sm text-slate-600 dark:text-slate-300">
          Articles are publishing soon. For now, you can request updates at{' '}
