...
export const navItems: NavItem[] = [
  ...
  { label: 'nav.referralPartners', href: '/partners', group: 'operations', permissionId: 'customers', moduleKey: 'customers' },
  ...
  { label: 'nav.suppliers', href: '/suppliers', group: 'finance', permissionId: 'ledger', moduleKey: 'payments' },
  { label: 'nav.expenses', href: '/expenses', group: 'finance', permissionId: 'ledger', moduleKey: 'payments' },
  { label: 'nav.books', href: '/books', group: 'finance', permissionId: 'ledger', moduleKey: 'payments' },
  { label: 'nav.financials', href: '/financials', group: 'finance', permissionId: 'ledger', moduleKey: 'payments' },
  { label: 'nav.gst', href: '/gst', group: 'finance', permissionId: 'ledger', moduleKey: 'payments', featureKey: 'gstBilling' },
...
export const pageTitles: Record<string, string> = {
  ...
  '/suppliers': 'title.suppliersPayables',
  ...
  '/partners': 'title.referralPartners',
